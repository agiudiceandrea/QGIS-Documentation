...
* Download sample data from
  `here <https://github.com/qgis/QGIS-Sample-Data/archive/master.zip>`_ and unzip the archive
...
from `here <https://github.com/qgis/QGIS-Sample-Data/archive/master.zip>`_ and unzip the archive
on any convenient location on your system.
